			...
			<div class="card-body">
				<div class="row">
					<div class="form-group mb-3 row">
						...
						<div class="col">
							<input type="text" class="form-control" placeholder="제목을 입력해주세요"
								value="${notice.ntc_title }" id="ntc_title">
						</div>
					</div>
					<div class="form-group mb-3 row">
						...
						<div class="col">
							<input type="text" class="form-control" placeholder="작성자ID"
								readonly="readonly" value="${notice.ntc_writerid }">
						</div>
					</div>
					<div class="form-group mb-3 row">
						...
						<div class="col-1">
							<label class="form-check"> <input
								class="form-check-input" type="checkbox" id="ntc_popyn">
								<span class="form-check-label">팝업게시</span>
							</label>
						</div>
						<div class="col-2 previewBtn" style="display: none;">
							<a href="" onclick="previewPopupOpen();"
								...
								data-toggle="modal"> <svg xmlns="http://www.w3.org/2000/svg"
					...
					<div class="form-group mb-2 row popupDate" style="display: none;">
						...
						<div class="col-4">
							<div class="row">
								<label class="form-label col-4 col-form-label">팝업 종료 일자:</label>
								<div class="col">
									<div class="input-icon">
					...
					<div class="form-group mb-3 row">
						...
						<div>
							<textarea class="form-control" id="summernoteContent"></textarea>
						</div>
					</div>
					<div class="form-group mb-3 row" id="fileDrop">
						<label class="row  px-0">
						...
						<div class="divide-y" id="appendArea">
							<div>
								<label class="row m-0"
									...
									<span class="text-center p-4">여기에 파일을 drag &amp; drop
										해주세요</span>
								</label>
							</div>
								...
								<div id="fileRow">
									<label class="row"> <span class="col">${attach.attc_extnm }
											...
											<svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4 17v2a2 2 0 0 0 2 2h12a2 2 0 0 0 2 -2v-2" /><polyline points="7 11 12 16 17 11" /><line x1="12" y1="4" x2="12" y2="16" /></svg>
												...
												data-src="${attach.attc_no }"> <a  href="javascript:void(0);" 
				...
				<div class="form-footer">
					<button type="button" onclick="modNoticeBtn();"
