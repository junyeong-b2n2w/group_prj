						...
						<table
							...
							<thead>
								<tr>
									...
									<th style="width: 32%;" class="edocListorderby" role="ed_aprvtitle">제목<i class="fas fa-sort ml-3"></i></th>
									...
									<th style="width: 3%;" class="edocListorderby" role="ed_aprvstt"><i class="fas fa-sort ml-3"></i></th>
...
<%@ include file="refReadList_js.jsp" %>
