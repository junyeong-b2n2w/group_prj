						...
						<table
							...
							<thead>
								<tr>
									...
									<th style="width: 14%;" class="edocListorderby" role="ed_comymd">완료일<i class="fas fa-sort ml-3"></i></th>
									<th style="width: 6%;" class="edocListorderby" role="ed_aprvstt">상태</th>
									<th style="width: 6%;" class="edocListorderby" role="ed_aprvstt"><i class="fas fa-sort ml-3"></i></th>
								</tr>
							</thead>
