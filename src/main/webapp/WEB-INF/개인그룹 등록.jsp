...
<script
	src="<%=request.getContextPath()%>/resources/assets/js/require.min.js"></script>
<script>
      requirejs.config({
          baseUrl: '.'
      });
...
<!-- Dashboard Core -->
<link
	href="<%=request.getContextPath()%>/resources/assets/css/dashboard.css"
	rel="stylesheet" />
<script src="./assets/js/dashboard.js"></script>
<!-- c3.js Charts Plugin -->
<link
	href="<%=request.getContextPath()%>/resources/assets/plugins/charts-c3/plugin.css"
	rel="stylesheet" />
<script
	src="<%=request.getContextPath()%>/resources/assets/plugins/charts-c3/plugin.js"></script>
<!-- Google Maps Plugin -->
<link
	href="<%=request.getContextPath()%>/resources/assets/plugins/maps-google/plugin.css"
	rel="stylesheet" />
<script
	src="<%=request.getContextPath()%>/resources/assets/plugins/maps-google/plugin.js"></script>
<!-- Input Mask Plugin -->
<script
	src="<%=request.getContextPath()%>/resources/assets/plugins/input-mask/plugin.js"></script>
</head>
<body class="">
	<div class="page">
		<div class="page-main">
				...
				<div class="container">
					<div class="d-flex">
						<a class="header-brand" href="./index.html"> <img
							src="<%=request.getContextPath()%>/resources/demo/brand/tabler.svg"
            ...
            <div class="col-md-6">
              <div class="card mb-3">
                <div class="card-header">
                  <h3 class="card-title">개인 그룹 목록</h3>
                </div>
                <div class="card-body">
                  <div class="row g-3">
                    <div class="col-6">
                      <div class="row g-3 align-items-center">
                        ...
                        <div class="col text-truncate">
                          <a href="#" class="text-body d-block text-truncate">개인그룹1</a>
                          <small class="text-muted text-truncate mt-n1"></small>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="row g-3">
                    <div class="col-6">
                      <div class="row g-3 align-items-center">
                        ...
                        <div class="col text-truncate">
                          <a href="#" class="text-body d-block text-truncate">개인그룹2</a>
                          <small class="text-muted text-truncate mt-n1"></small>
                        </div>
                      </div>
                    </div>
                  ...
                  <h3 class="card-title">그룹 등록</h3>
                            ...
                            <div class="card-body">
                              ...
                              <div class="mb-3">
                                ...
                                <input type="text" class="form-control" style="width: 88%; display: inline-block;">
                                 <a href="#" class="btn  btn btn-outline-primary w-40" style="float: right; height: 38px;">
                                	<svg xmlns="http://www.w3.org/2000/svg" class="icon me-1" width="30" height="30" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><circle cx="12" cy="7" r="4"></circle><path d="M6 21v-2a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v2"></path></svg>
                                </a>
                              ...
                              <div class="mt-2">
                                <a href="#" class="btn  btn-outline-primary w-40" style="float: right;">
                                	취소
                                </a>
